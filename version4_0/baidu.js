...
function screen() {
	...
	if(sUserAgent.indexOf("window") > 0){
		//alert(sUserAgent);
...
function keyChange() {
	...
	input.onkeyup = function (event) {
        ...
        if (e && e.keyCode == 13) {
			...
			if(document.getElementsByClassName("inputFrame")[0].value != ""){
				document.getElementById("clearImg").style.display = "block";
				document.getElementsByClassName("inputFrame")[0].style.borderRadius="10px 0 0 0";
			}else{
				document.getElementsByClassName("inputFrame")[0].style.borderRadius="10px 0 0 10px";
...
function clearContent(){
	document.getElementsByClassName("inputFrame")[0].value = "";
	document.getElementById("clearImg").style.display = "none";
	document.getElementsByClassName("inputFrame")[0].style.borderRadius="10px 0 0 10px";
	appendScript(0);
}
